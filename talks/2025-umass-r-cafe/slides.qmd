...
5. 2 also means that my interest in reproducibility is for future Emily and for sound science
...
The R script that created my custom template in my personal R package on GitHub [here](https://github.com/zabore/ezfun/blob/master/data-raw/project_template.R).
...
1. R script where data are cleaned and coded and saved into .rda
...
1. Notes/questions: these are notes on things I did in the data cleaning process that I want to call attention to, i.e. how categories were combined, missing data to address, etc.
2. Methods: A formal statistical methods section that can be copied and pasted directly into the eventual scientific publication
3. Results: Mostly tables and figures with some text interpretation mixed in.

...
<script async class="speakerdeck-embed" data-id="abe8ee65f2c34eba9537c421600880d5" data-ratio="1.33333333333333" src="//speakerdeck.com/assets/embed.js"></script>
...
We compare clutering on the full gene set to clustering on principal components, and unsupervised dimension reduction approach, to clustering on a gene set pre-filtered according to univariate D for each gene, and finally to clustering on a gene set pre-filtered according to an F-statistic proposed by Zapala & Schork, which I will go into more detail about in a few slides.
...
Many thanks to my dissertation advisors, Colin Begg and Shuang Wang.


## MPE 2016

At the Molecular Pathologic Epidemiology meetings held in Boston, MA, I presented a talk titled "A review of statisitcal methods for evaluating etiologic heterogeneity" on May 12, 2016. A PDF of the slides is available [here](https://github.com/zabore/talk-slides/blob/master/Zabor-MPE2016-presentation-2016-05-12.pdf).

<script async class="speakerdeck-embed" data-id="6b0fbacf82074586918d22f899d96317" data-ratio="1.33333333333333" src="//speakerdeck.com/assets/embed.js"></script>
